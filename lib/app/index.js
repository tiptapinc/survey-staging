...
app.fn('add', function(e){
  ...
  this.list.insert(i, {text: text, completed: false});
...
app.ready(function(model){
  ...
  require('./../../public/jquery/jquery-2.0.2.js');
  require('./../../public/jquery/jquery-ui-1.10.3.custom.js');
  ...
  this.list.on('change', 'todos.*.completed', function(i, completed, previous, isLocal){
